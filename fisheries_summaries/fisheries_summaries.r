...
Catch.Plot = function(dat=dat, fishery=1, collist=collist, all.yrs = 1970:2013)   # Calculates and plots catch of a fishery by year and fleet
{
    tmp.dat <- dat[dat$fsh == fishery,]    
...
Sz.N.Plot <- function(tab.dat=L.N.tab, y.lab="No. fish measured", collist=collist, xbrks=seq(1970, 2010, 10))   # Makes a plot of the number of size samples for a fishery - bar plot
{
